...
export default function CommissionUI({
  ...
  return (
    <div className="h-full w-[390px] bg-white-0 p-4">
      <Header text="중개수수료 계산기" href="/" />
      <PolicyBanner moreInfo={moreInfo} setMoreInfo={setMoreInfo} />
      <div className="w-full flex flex-col gap-5 mt-10">
        <section>
          <span className="text-[18px] font-bold">매물 종류</span>
          <div className="w-full text-[18px] mt-3 border">
        ...
        <form
          ...
          <div className="w-full flex items-center relative mt-3">
            <input
              ...
              maxLength={15}
              className="w-full h-[54px] p-[3px_35px_3px_4px] text-right border rounded-md focus:outline-none"
            />
